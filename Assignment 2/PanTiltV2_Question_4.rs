...
fn main() {
    ...
    let apple_movement_tilt_constants: [f64; 4] = calc_constants(0.0, PI / 6.0 + 0.2, 0.0, 0.0, 0.0, 2.0);
    let ball_movement_pan_constants: [f64; 4] = calc_constants(7.0 * PI / 4.0, PI / 4.0, 0.0, 0.0, 2.0, 5.0);
    let ball_movement_tilt_constants: [f64; 4] = calc_constants(PI / 6.0 + 0.2, PI / 6.0 + 0.15, 0.0, 0.0, 2.0, 5.0);
    let origin_movement_pan_constants: [f64; 4] = calc_constants(PI / 4.0, 0.0, 0.0, 0.0, 5.0, 7.0);
